...
/* PostScannersParams contains all the parameters to send to the API endpoint
   for the post scanners operation.
...
// WithDefaults hydrates default values in the post scanners params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostScannersParams) WithDefaults() *PostScannersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post scanners params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostScannersParams) SetDefaults() {
