...
/* PutScannersRegistrationIDParams contains all the parameters to send to the API endpoint
   for the put scanners registration ID operation.
...
// WithDefaults hydrates default values in the put scanners registration ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutScannersRegistrationIDParams) WithDefaults() *PutScannersRegistrationIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put scanners registration ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutScannersRegistrationIDParams) SetDefaults() {
...
func (o *PutScannersRegistrationIDParams) WithRegistration(registration *legacy.ScannerRegistrationReq) *PutScannersRegistrationIDParams {
