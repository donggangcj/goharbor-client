...
func (o *PostProjectsProjectIDImmutabletagrulesParams) WithDefaults() *PostProjectsProjectIDImmutabletagrulesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *PostProjectsProjectIDImmutabletagrulesParams) SetDefaults() {
